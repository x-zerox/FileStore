...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1001547058298"))
#put 0 to disable
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "5935267941 1329298095 6103092779 5231212075 7328629001").split()):
        ADMINS.append(int(x))
except ValueError:
